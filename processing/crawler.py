...
speeches_filepath_json = SAVE_PATH / "data" / "speeches.json"
speeches_filepath_csv = SAVE_PATH / "data" / "speeches.csv"
...
def crawler():
    ...
    for speech in speeches["datasource"]:
        ...
        pprint.pprint(speech_dict["publication"])
        speech_dict["title"] = (
